...
class ICollectionTileData(model.Schema):
    title = schema.TextLine(
        title=_("collection_tile_title", u"Tile title"),
        description=_(
    ...
    collection_uid = schema.Choice(
        title=_("collection_tile_collectionuid", u"Collection"),
        description=_(
            "collection_tile_collectionuid_help", u"Select a collection."
        ),
    ...
    limit = schema.Int(
        title=_("collection_tile_limit", u"Number of results"), required=False
    )

    show_dates = schema.Bool(
        title=_("collection_tile_showdates", u"Show dates"),
        required=False,
        default=False,
    )
    ...
    random = schema.Bool(
        ...
        description=_(
            u"If enabled, items will be selected randomly from the "
    ...
    show_more = schema.Bool(
        ...
        description=_(
            u'If enabled, a "More..." link will appear '
            u"in the tile, linking to the underlying "
            u"Collection."
        ),
        required=False,
        default=True,
    ...
    directives.widget(
        "show_more_collection_uid",
        RelatedItemsFieldWidget,
        pattern_options={
            "selectableTypes": ["Collection", "Folder", "Document", "Topic"]
        },
    )
    ...
    renderer = schema.Choice(
        title=_("collection_tile_renderer", u"Renderer"),
        description=_(
